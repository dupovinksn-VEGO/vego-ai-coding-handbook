...
const checks = [
  ["web/index.html", ["VEGO AI Coding 寶典", "Sandbox Review", "English summary", "審核駕駛艙", "chapterReader", "智庫工具", "物流與供應鏈智庫地圖"]],
  ...
  ["web/styles.css", ["@media (max-width: 920px)", "grid-template-columns", "border-radius: 8px", "queue-grid", "collector-layout", "chapter-reader", "domain-grid"]],
  ["web/data.js", ["window.VEGO_DATA", "handbook", "skills", "articles", "sources", "sandboxSkills", "\"html\"", "logistics-exception-management", "external-skill-converter", "智庫工具與外部電子書", "物流與供應鏈智庫"]],
