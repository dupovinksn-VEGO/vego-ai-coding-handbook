window.VEGO_DATA = {
  "generatedAt": "2026-05-04T23:53:19.050Z",
  "handbook": [
    {
      "index": "00",
      "title": "目錄與使用方式",
  ...
  "skills": [
    ...
    {
      "name": "voice-briefing-producer",
      "author": "VEGO",
      "category": "VEGO Skill",
      "description": "將寶典章節、文章或智庫更新整理成適合通勤聆聽的語音讀報稿。Use when turning handbook knowledge into short listenable briefings.",
      "status": "approved",
      "risk": "low",
      "url": "",
      "path": "content/skills/voice-briefing-producer/SKILL.md"
    }
  ],
  "articles": [
    {
